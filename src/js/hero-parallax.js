if (window.innerWidth >= 1440) {
  ...
  window.addEventListener('scroll', function () {
    ...
    if (scrollPosition < 900) {
      ...
      gearWhite.style.transform = `translateX(${
        scrollPosition * 0.4
      }px) rotate(${scrollPosition * 0.3}deg)`;
      gearRed.style.transform = `translateX(${
        -scrollPosition * 0.4
      }px) rotate(${-scrollPosition * 0.4}deg)`;
      ...
      arrowWhite.style.transform = `translateX(${
        -scrollPosition * 0.2
      }px) rotate(${scrollPosition * 0.1}deg)`;
      arrowRed.style.transform = `translateX(${
        scrollPosition * 0.2
      }px) rotate(${scrollPosition * 0.1}deg)`;
